...
if __name__ == "__main__":
    ...
    from pointcept.models.point_transformer_v3.openpoints.dataset import ModelNet, vis_points
    from pointcept.models.point_transformer_v3.openpoints.models.layers import fps
